...
export default function AboutConstellations() {
  ...
  useEffect(() => {
    ...
    const MAX_NODES = window.innerWidth < 768 ? 6 : 85; // Distributed across the 4 border perimeters
    const LINK = window.innerWidth < 768 ? 50 : 145; // Distance to connect stars
