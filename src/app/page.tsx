  ...
  return (
    <main className="hero-bg relative w-full h-screen overflow-hidden bg-[#020712]">
      ...
      */}
      ...
      <div
        className="absolute top-[12%] sm:top-[2%] left-[3%] sm:left-[6%] w-[35vw] sm:w-[25vw] md:w-[20vw] max-w-[310px] aspect-[0.75] pointer-events-none select-none z-[25] transition-transform duration-300 ease-out"
        style={{
      ...
      >
        <div className="relative -translate-y-6 sm:-translate-y-10 w-[98vw] sm:w-[90vw] max-w-[1200px] h-[75vh] sm:h-[65vh] md:h-[75vh] lg:h-[95vh] flex items-center justify-center">
          ...
          <div className="absolute top-[10%] sm:top-[30%] md:top-[30%] lg:top-[32%] pointer-events-none z-40 flex items-center gap-3">
          ...
          {/* High-End Agency-Grade Register Button - Artistic Celestial Texture Integrated */}
          <div className="absolute bottom-[10%] sm:bottom-[14%] md:bottom-[18%] lg:bottom-[22%] pointer-events-auto z-40">
            <button
              onClick={() => triggerLaunch("/register")}
              className="group relative inline-flex items-center justify-center p-1 sm:p-1.5 rounded-full bg-[#020712]/80 border border-[#fbbf24]/45 backdrop-blur-2xl shadow-[0_0_35px_rgba(251,191,36,0.35),0_12px_35px_rgba(0,0,0,0.9)] hover:border-[#fbbf24]/80 hover:shadow-[0_0_55px_rgba(251,191,36,0.6),0_18px_45px_rgba(0,0,0,0.95)] transition-all duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] hover:scale-105 active:scale-95 cursor-pointer"
            >
              {/* Outer Celestial Glow Atmosphere */}
              <span className="absolute -inset-1.5 rounded-full bg-gradient-to-r from-[#fbbf24]/35 via-[#2dd4bf]/30 to-[#fbbf24]/35 blur-xl opacity-60 group-hover:opacity-100 transition-opacity duration-500" />

              {/* Double-Bezel Inner Core with Celestial Texture Map Layer */}
              <div className="relative flex items-center gap-3.5 sm:gap-4.5 rounded-full px-7 sm:px-9 py-3.5 sm:py-4 bg-[#03091e]/90 border border-[#fbbf24]/40 shadow-[inset_0_1px_2px_rgba(255,255,255,0.3)] overflow-hidden">
                {/* Celestial Constellation Texture Overlay */}
                <div className="absolute inset-0 bg-[url('/celestial-text-bg.png')] bg-cover bg-center opacity-30 mix-blend-screen pointer-events-none group-hover:opacity-45 transition-opacity duration-500" />

                {/* Micro Glint Sweep Effect on Hover */}
                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-[#fbbf24]/30 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000 ease-in-out pointer-events-none" />

                {/* Artistic Celestial Text Label */}
                <div className="relative z-10 flex items-center gap-2">
                  <span className="text-[10px] text-amber-300/80 font-serif">✦</span>
                  <span className="text-sm sm:text-base md:text-lg font-black tracking-[0.35em] uppercase text-amber-100 group-hover:text-white transition-colors duration-300 font-serif drop-shadow-[0_0_12px_rgba(251,191,36,0.7)]">
                    REGISTER
                  </span>
                  <span className="text-[10px] text-amber-300/80 font-serif">✦</span>
                </div>
